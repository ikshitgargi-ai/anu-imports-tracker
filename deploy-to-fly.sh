#!/usr/bin/env bash
# ===========================================================================
# Anu Imports Tracker — One-shot Fly.io deploy
# ===========================================================================
#
...
APP_NAME="${APP_NAME:-anu-imports-tracker}"
...
if [ -f .env.fly ]; then
  ...
  echo "   flyctl secrets set CORS_ORIGINS=https://anu-imports-web.vercel.app -a $APP_NAME"
fi
...
echo "============================================================"
echo ""
echo "  1. https://vercel.com/dashboard → anu-imports-web → Settings → Env Variables"
echo "  2. Edit NEXT_PUBLIC_API_BASE for Production:"
echo "       OLD: https://anu-imports-tracker.onrender.com"
echo "       NEW: $URL"
echo "  3. Deployments → click ⋯ on latest → Redeploy (without cache)"
echo "  4. Wait ~90s, visit https://anu-imports-web.vercel.app — now hitting Fly"
echo ""
echo "  Once verified, you can suspend the Render service to stop the credit emails:"
echo "  Render dashboard → anu-imports-tracker → Settings → Suspend Service"
echo ""
