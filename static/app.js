/* ===== Anu Imports Tracker - Frontend Engine ===== */
...
async function loadDashboard() {
  ...
  document.getElementById('statsGrid').innerHTML = `
    ...
    <div class="stat-card" style="border-left:3px solid #d8ad58"><div class="label">Rock Paper</div><div class="value" style="color:#d8ad58">${prods['Rock Paper'] || 0}</div></div>
    <div class="stat-card" style="border-left:3px solid #2dd4a8"><div class="label">Goenchi + Fratelli</div><div class="value" style="color:#2dd4a8">${(prods['Goenchi'] || 0) + (prods['Fratelli'] || 0)}</div></div>
...
async function loadInventory() {
  ...
  grid.innerHTML = products.map(p => `
    <div class="inventory-card inv-anu">
  ...
  try {
    ...
    grid.innerHTML = `
      ...
      <div class="stat-card">
        ...
        <div class="stat-sub">Anu import portfolio</div>
      </div>
    `;
    // Recent runs table
