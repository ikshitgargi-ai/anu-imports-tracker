...
async function loadDashboard() {
  ...
  document.getElementById('statsGrid').innerHTML = `
    ...
    <div class="stat-card" style="border-left:3px solid #e17055"><div class="label">Rock Paper</div><div class="value" style="color:#e17055">${prods['Rock Paper'] || 0}</div></div>
    <div class="stat-card" style="border-left:3px solid #00cec9"><div class="label">Goenchi + Fratelli</div><div class="value" style="color:#00cec9">${(prods['Goenchi'] || 0) + (prods['Fratelli'] || 0)}</div></div>
